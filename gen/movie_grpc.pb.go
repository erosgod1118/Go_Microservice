...
type RatingServiceClient interface {
	...
	StartIngestion(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *ratingServiceClient) StartIngestion(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type RatingServiceServer interface {
	...
	StartIngestion(context.Context, *Empty) (*Empty, error)
...
func (UnimplementedRatingServiceServer) StartIngestion(context.Context, *Empty) (*Empty, error) {
...
func _RatingService_StartIngestion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).StartIngestion(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
